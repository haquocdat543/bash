...
source "$(dirname "${BASH_SOURCE[0]}")/navigation/ripgrep.sh"
...
source "$(dirname "${BASH_SOURCE[0]}")/package/yum.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/dnf.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/apt.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/apk.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/pip.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/python.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/conda.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/pyenv.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/nvm.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/npm.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/npx.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/yarn.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/poetry.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/uv.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/conan.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/composer.sh"
source "$(dirname "${BASH_SOURCE[0]}")/package/bun.sh"
...
source "$(dirname "${BASH_SOURCE[0]}")/git/crypt.sh"
...
source "$(dirname "${BASH_SOURCE[0]}")/programming/dotnet.sh"
...
# DATA
source "$(dirname "${BASH_SOURCE[0]}")/data/dbt.sh"
